...
DROP TABLE IF EXISTS students_;
...
INSERT INTO students_(student_name, email, year)
SELECT DISTINCT student_name, email, year FROM etudiants;
...
CREATE TABLE house(
    ...
    id_students INT,
    FOREIGN KEY (id_students) REFERENCES students_(id_students)
);
...
INNER JOIN students_ ON etudiants.student_name = students_.student_name;
